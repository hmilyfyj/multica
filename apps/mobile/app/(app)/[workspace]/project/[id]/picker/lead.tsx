 ...
 * UISearchController; other platforms: the shared `SearchField` above the
 * list). Self-contained: reads project from cache, fires useUpdateProject
 * directly.
 */
...
export default function ProjectLeadPickerRoute() {
  ...
  const { query, searchBar } = usePickerSearchBar("Search members or agents", {
    autoFocus: true,
  });
